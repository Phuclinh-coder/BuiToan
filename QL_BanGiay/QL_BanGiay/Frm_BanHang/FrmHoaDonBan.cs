...
namespace QL_BanGiay
{
    public partial class FrmHoaDonBan : Form
    {
        ...
        void xuatexcel()
        {
            if (danhSachBan.Rows.Count > 0) //TH có dữ liệu để ghi
            {
               ...
               exApp.Workbooks.Add(Excel.XlWBATemplate.xlWBATWorksheet);
                ...
                tenCuaHang.Value = "CỬA HÀNG BÁN GIÀY";
                ...
                exSheet.get_Range("B7").Value = "Mã giày";
                exSheet.get_Range("C7").Value = "Tên giày";
               ...
               // exSheet.get_Range("G7").Value = "Tổng tiền:"+tongTien();
                ...
                for (int i = 0; i < danhSachBan.Rows.Count; i++)
                   ...
                   .Font.Bold = false;
                    ...
                    exSheet.get_Range("D" + (i + 8).ToString()).Value = danhSachBan.Rows[i].Cells["MaGiay"].ToString();
                    exSheet.get_Range("E" + (i + 8).ToString()).Value = danhSachBan.Rows[i].Cells["TenGiay"].ToString();
        ...
        private void sua_Click(object sender, EventArgs e)
        {
            ...
            data.UpdateData(sql);
            sql += " Select tChiTietHDB.MaGiay,TenGiay,SLBan,DonGiaBan,KhuyenMai from tChiTietHDB join tGiay on tChiTietHDB.MaGiay = tGiay.MaGiay ";
            danhSachBan.DataSource = data.ReadData(sql);
        }
